...
The document is laid out in following sections and is followed by an [alphabetical index of terms](#index-of-casting-terms) linked to their definitions.

- [Fly Casting](#fly-casting)
- [Loops](#loops)
- [Fly Leg Shapes](#fly-leg-shapes)
- [Fly Casting Movements](#fly-casting-movements)
- [Rod Movements During Pause](#rod-movements-during-pause)
- [Casting Terms](#casting-terms)
- [Casts and Techniques](#casts-and-techniques)
- [Physics Terms for Fly Casting](#physics-terms-for-fly-casting)
...
![Convex Fly Leg](/img/ffi-casting/Casting_Convex.png)

### Concave Fly Leg
A Fly Leg which is not Straight and dips toward Rod Leg.

![Concave Fly Leg](/img/ffi-casting/Casting_Concave.png)
...
![Tailing Loop](/img/ffi-casting/Casting_TailingLoop.png)

### Under-Running Loop
A Loop whose Fly Leg unrolls below its Rod Leg.

![Under-Running Loop](/img/ffi-casting/Casting_Underslung.png)

### In-Plane Loop
A Loop whose Fly Leg and Rod Leg are in same plane.

![In-Plane Loop](/img/ffi-casting/Casting_Plane_InPlaneLoop.png)

### Out-of-Plane Loop
A Loop whose Fly Leg and Rod Leg are in different planes.

![Out-of-Plane Loop](/img/ffi-casting/Casting_Plane_OutOfPlaneLoop.png)
...
![Stroke Length](/img/ffi-casting/Casting_StrokeLength.png)

### Casting Arc
The angle change of rod butt during Casting Stroke.

![Casting Arc](/img/ffi-casting/Casting_Arc.png)
...
![Back Cast and Forward Cast Drift](/img/ffi-casting/Casting_Drift.png)

### Drag
Moving rod tip in direction of next cast during Pause.

![Back Cast and Forward Cast Drag](/img/ffi-casting/Casting_Drag.png)
...
**Source:** [Fly Fishers International](https://www.flyfishersinternational.org/Fly-Casting-Education/FFI-Fly-Casting-Definitions)